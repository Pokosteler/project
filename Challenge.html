...
<html lang="en" ng-app>
  ...
  <body>
      ...
      <div class="article container" ng-controller="Challenge">
        <p id="challenge-str">Challenge #1 (from <a href="#">system</a>)</p>   
          <form class="dictionary">
             ...
             <div class="form-group" ng-button="addTodo()">
               <input type="button" value="add to dictionary" class="btn btn-inverse input-word" id="add-to-dictionary" onclick="location.href = 'challenges.html';">
             </div>
      </div>
