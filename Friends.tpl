...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        <p id="friends-str">Friends</p>
        <div class="friends-search table-responsive">
        <table class="table table-bordered table-hover table-fixed">
    <thead>
      <tr class="active">
        <th class="col-xs-4">Username</th>
        <th class="col-xs-4">Challenge</th>
        <th class="col-xs-4">Status</th>
      </tr>
    </thead>
    <tbody>
      <tr class="active">
        <td class="col-xs-4"><a href="Username.html">Username1</a></td>
        <td class="col-xs-4"><a href="challenge.html">call on challenge</a></td>
        <td class="col-xs-4"><a href="#">delete from friends</a></td>
      </tr>
      <tr class="active">
        <td class="col-xs-4"><a href="Username.html">Username2</a></td>
        <td class="col-xs-4"><a href="challenge.html">call on challenge</a></td>
        <td class="col-xs-4"><a href="#">delete from friends</a></td>
      </tr>
      <tr class="active">
        <td class="col-xs-4"><a href="Username.html">Username3</a></td>
        <td class="col-xs-4"><a href="challenge.html">call on challenge</a></td>
        <td class="col-xs-4"><a href="#">delete from friends</a></td>
      </tr>
      <tr class="active">
        <td class="col-xs-4"><a href="Username.html">Username4</a></td>
        <td class="col-xs-4"><a href="challenge.html">call on challenge</a></td>
        <td class="col-xs-4"><a href="#">delete from friends</a></td>
      </tr>
      <tr class="active">
        <td class="col-xs-4"><a href="Username.html">Username5</a></td>
        <td class="col-xs-4"><a href="challenge.html">call on challenge</a></td>
        <td class="col-xs-4"><a href="#">delete from friends</a></td>
      </tr>
      <tr class="active">
        <td class="col-xs-4"><a href="Username.html">Username6</a></td>
        <td class="col-xs-4"><a href="challenge.html">call on challenge</a></td>
        <td class="col-xs-4"><a href="#">delete from friends</a></td>
      </tr>
    </tbody>
