...
<html lang="en">
  ...
  <body>
      ...
      <form class="form-horizontal">
        ...
        <div class="form-group">
           <div class="col-xs-6" id="username-profile">
              Username
           </div>
           <div class="col-xs-6" id="email-profile">
              E-mail
           </div>
           <div class="col-xs-6" id="date-profile">
              Date of birth
           </div>
           <div class="col-xs-6" id="sex-profile">
              Sex
           </div>
           <div class="col-xs-6" id="country-profile">
              Country
           </div>
           <div class="col-xs-6" id="city-profile">
              City
           </div>
        </div>
       </form>
